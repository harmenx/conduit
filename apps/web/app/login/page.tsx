      ...
      <div className="w-full max-w-sm space-y-8 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 shadow-2xl backdrop-blur-sm">
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-md border border-zinc-800 bg-zinc-950 px-4 py-2.5 text-sm font-medium hover:bg-zinc-900 transition-all active:scale-95 shadow-sm"
          >
